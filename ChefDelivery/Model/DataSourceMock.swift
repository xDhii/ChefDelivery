...
let storesMock: [StoreType] = [
	StoreType(
		...
		products: [
			...
			ProductType(
				...
				description: "Lata de refrigerante de 355ml", image: "soda",
				price: 3.99),
			ProductType(
	...
	StoreType(
		...
		products: [
			ProductType(
				id: 16, name: "Pão Francês",
				description: "Pão francês fresquinho", image: "french_bread",
				price: 0.50),
			ProductType(
				id: 17, name: "Croissant", description: "Croissant folhado",
				image: "croissant", price: 2.99),
			ProductType(
				id: 18, name: "Rosca Doce",
				description: "Rosca doce com cobertura de açúcar",
				image: "sweet_bread", price: 3.99),
			ProductType(
				id: 19, name: "Bolo de Chocolate",
				description: "Fatia de bolo de chocolate",
				image: "chocolate_cake_slice", price: 4.99),
			ProductType(
				id: 20, name: "Café", description: "Café quente",
				image: "coffee", price: 1.99),
		]
	),
	StoreType(
		id: 5,
